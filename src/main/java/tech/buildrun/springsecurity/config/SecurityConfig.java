...
public class SecurityConfig {
    ...
    @Bean
    public SecurityFilterChain securityFilterChain(@org.jetbrains.annotations.NotNull HttpSecurity http, InputSanitizationFilter inputSanitizationFilter) throws Exception {
        http
                .cors(cors -> cors.configurationSource(corsConfigurationSource()))
                // Desabilitar CSRF para APIs REST
                .csrf(AbstractHttpConfigurer::disable)
                .addFilterBefore(inputSanitizationFilter, BasicAuthenticationFilter.class)
